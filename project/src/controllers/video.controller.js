...
const getAllVideos = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, { videos, totalVideos, currentPage: Number(page), totalPages: Math.ceil(totalVideos / limit) }, "Videos fetched successfully!"))
...
const publishAVideo = asyncHandler(async (req, res) => {
    ...
    // to get video, upload to cloudinary, create video
